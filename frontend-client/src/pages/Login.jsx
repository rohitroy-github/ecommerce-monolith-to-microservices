    ...
    <main className="flex min-h-screen items-center justify-center">
      <section className="w-full max-w-md rounded-3xl border border-zinc-200/80 bg-white p-7 shadow-[0_24px_60px_-24px_rgba(0,0,0,0.35)] sm:p-8">
        <div className="mb-7">
          ...
          <h2 className="mt-4 text-3xl font-bold tracking-tight text-zinc-900">Welcome back</h2>
          <p className="mt-2 text-sm leading-6 text-zinc-600">
            Sign in to continue managing products, orders, and account activity.
          </p>
        </div>

        <form onSubmit={handleSubmit} className="grid gap-4">
          <label className="grid gap-2 text-sm font-medium text-zinc-700" htmlFor="login-email">
            Email
            <input
              id="login-email"
              type="email"
          ...
          <label className="grid gap-2 text-sm font-medium text-zinc-700" htmlFor="login-password">
            Password
